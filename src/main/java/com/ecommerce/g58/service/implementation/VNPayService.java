...
public class VNPayService {
    ...
    public String recharge(int total, String orderInfor, String urlReturn) {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_TxnRef = VNPayConfig.getRandomNumber(8);
        String vnp_IpAddr = "127.0.0.1";
        ...
        String locale = "vn";
        vnp_Params.put("vnp_Locale", locale);
        vnp_Params.put("vnp_ReturnUrl", urlReturn + "/vnpay-recharge-return");
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
    ...
    public String rechargeSeller(int total, String orderInfor, String urlReturn) {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_TxnRef = VNPayConfig.getRandomNumber(8);
        String vnp_IpAddr = "127.0.0.1";
        ...
        String locale = "vn";
        vnp_Params.put("vnp_Locale", locale);
        vnp_Params.put("vnp_ReturnUrl", urlReturn + "/vnpay-recharge-return-seller");
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
    ...
    public String rechargeLogistic(int total, String orderInfor, String urlReturn) {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_TxnRef = VNPayConfig.getRandomNumber(8);
        String vnp_IpAddr = "127.0.0.1";
        ...
        String locale = "vn";
        vnp_Params.put("vnp_Locale", locale);
        vnp_Params.put("vnp_ReturnUrl", urlReturn + "/vnpay-recharge-return-logistic");
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
    ...
    public String rechargeAdmin(int total, String orderInfor, String urlReturn) {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_TxnRef = VNPayConfig.getRandomNumber(8);
        String vnp_IpAddr = "127.0.0.1";
        ...
        String locale = "vn";
        vnp_Params.put("vnp_Locale", locale);
        vnp_Params.put("vnp_ReturnUrl", urlReturn + "/vnpay-recharge-return-admin");
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
