...
public class WishlistServiceImpTest {
    ...
    public void testAddProductToWishlist_Success() {
        ...
        when(wishlistRepository.findByUserIdAndProductVariation(anyInt(), any(ProductVariation.class))).thenReturn(Optional.empty());
    ...
    public void testAddProductToWishlist_AlreadyExists() {
        when(productVariationRepository.findById(anyInt())).thenReturn(Optional.of(productVariation));
        when(wishlistRepository.findByUserIdAndProductVariation(anyInt(), any(ProductVariation.class))).thenReturn(Optional.of(wishlist));
